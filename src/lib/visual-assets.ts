...
const testVisuals: Record<string, VisualAsset> = {
  "architecture-thinking": {
    src: "/generated/test-cover-task-setup.png",
    alt: "Четыре матовых чёрных модуля с цветными карточками KODO, выстроенные как план работы.",
    label: "task architecture",
    title: "Brief Assembly",
    description: "Постановка задачи как последовательная сборка контекста, ограничений и критериев готовности.",
    tone: "#B49F00",
  },
  "vibe-coding-profile": {
    src: "/generated/test-cover-codebase-debugging.png",
    alt: "Четыре чёрных модуля на рабочей поверхности, соединённые цветными кабелями; один кабель отсоединён для диагностики.",
    label: "trace the system",
    title: "Debug Route",
    description: "Кодовая база и отладка как поиск разрыва между связанными частями системы.",
    tone: "#6087C2",
  },
  "prompt-lint": {
    src: "/generated/test-cover-interface-product.png",
    alt: "Матовые интерфейсные плитки, сетка и цветные акриловые маркеры на тёмном рабочем столе.",
    label: "interface checks",
    title: "State Field",
    description: "Интерфейсная проверка через сетку, состояния и продуктовые приоритеты.",
    tone: "#A2649D",
  },
  "agent-stack-fit": {
    src: "/generated/test-cover-release-safety.png",
    alt: "Открытый чёрный кейс с капсулами проверки, цветными маркерами и контрольным переключателем.",
    label: "release check",
    title: "Release Case",
    description: "Проверка изменений и контролируемый выпуск как собранная процедура перед релизом.",
    tone: "#5B894B",
  },
};
